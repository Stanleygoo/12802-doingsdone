 ...
 * @param $active_project_id id текущего выбранного проекта
 * @param $query_params массив параметров запроса
 * @param $pathname имя скрипта, который бкдет использоваться как базовый путь
 *
 ...
 * @param $data массив с данными и вспомогательными флагами
